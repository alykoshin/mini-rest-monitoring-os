...
describe('mini-rest-monitoring-os', function () {

  describe('exports', function () {
    it('expect to export function', function () {
      expect(typeof MiniRestMonitoringOs === 'function');
    });
    ...
    it('expect to return valid HTTP response for parent handler', function (done) {
      request(app).get('/')
        ...
        .expect(function(res) {
          ...
          expect(res.body).to.have.all.keys(MiniRestMonitoringOs.keys);
        })
        .end(done)
      ;
    });

    MiniRestMonitoringOs.keys.forEach(function(key) {
